...
,
    ...
    { jp: "赤", ro: "aka", en: "red", tag: "color" },
    { jp: "青", ro: "ao", en: "blue", tag: "color" },
    { jp: "白", ro: "shiro", en: "white", tag: "color" },
    { jp: "黒", ro: "kuro", en: "black", tag: "color" },
    { jp: "緑", ro: "midori", en: "green", tag: "color" },
    { jp: "黄色", ro: "kiiro", en: "yellow", tag: "color" },
    { jp: "茶色", ro: "chairo", en: "brown", tag: "color" },
    { jp: "紫", ro: "murasaki", en: "purple", tag: "color" },
    { jp: "ピンク", ro: "pinku", en: "pink", tag: "color" },
    { jp: "父", ro: "chichi", en: "father (own)", tag: "family" },
    { jp: "母", ro: "haha", en: "mother (own)", tag: "family" },
    { jp: "お父さん", ro: "otōsan", en: "father (someone else's, polite)", tag: "family" },
    { jp: "お母さん", ro: "okāsan", en: "mother (someone else's, polite)", tag: "family" },
    { jp: "兄", ro: "ani", en: "older brother (own)", tag: "family" },
    { jp: "姉", ro: "ane", en: "older sister (own)", tag: "family" },
    { jp: "弟", ro: "otōto", en: "younger brother", tag: "family" },
    { jp: "妹", ro: "imōto", en: "younger sister", tag: "family" },
    { jp: "夫", ro: "otto", en: "husband (own)", tag: "family" },
    { jp: "妻", ro: "tsuma", en: "wife (own)", tag: "family" },
    { jp: "子供", ro: "kodomo", en: "child", tag: "family" },
    { jp: "天気", ro: "tenki", en: "weather", tag: "weather" },
    { jp: "晴れ", ro: "hare", en: "clear / sunny", tag: "weather" },
    { jp: "曇り", ro: "kumori", en: "cloudy", tag: "weather" },
    { jp: "雨", ro: "ame", en: "rain", tag: "weather" },
    { jp: "雪", ro: "yuki", en: "snow", tag: "weather" },
    { jp: "風", ro: "kaze", en: "wind", tag: "weather" },
    { jp: "そして", ro: "soshite", en: "and then / and", tag: "conjunction" },
    { jp: "でも", ro: "demo", en: "but / however", tag: "conjunction" },
    { jp: "だから", ro: "dakara", en: "so / therefore", tag: "conjunction" },
    { jp: "それから", ro: "sorekara", en: "after that / and then", tag: "conjunction" },
    { jp: "しかし", ro: "shikashi", en: "however (formal)", tag: "conjunction" },
    { jp: "よく", ro: "yoku", en: "often / well", tag: "adverb" },
    { jp: "時々", ro: "tokidoki", en: "sometimes", tag: "adverb" },
    { jp: "あまり", ro: "amari", en: "(not) much (with negative)", tag: "adverb" },
    { jp: "ぜんぜん", ro: "zenzen", en: "not at all (with negative)", tag: "adverb" },
    { jp: "もっと", ro: "motto", en: "more", tag: "adverb" },
    { jp: "やっぱり", ro: "yappari", en: "as expected / after all", tag: "adverb" },
    { jp: "きっと", ro: "kitto", en: "surely / certainly", tag: "adverb" },
    { jp: "多分", ro: "tabun", en: "probably / maybe", tag: "adverb" },
    { jp: "全部", ro: "zenbu", en: "all / everything", tag: "adverb" },
    { jp: "北", ro: "kita", en: "north", tag: "direction" },
    { jp: "南", ro: "minami", en: "south", tag: "direction" },
    { jp: "東", ro: "higashi", en: "east", tag: "direction" },
    { jp: "西", ro: "nishi", en: "west", tag: "direction" },
    { jp: "遠く", ro: "tōku", en: "far away", tag: "direction" },
    { jp: "覚える", ro: "oboeru", en: "to memorize / remember", tag: "verb" },
    { jp: "忘れる", ro: "wasureru", en: "to forget", tag: "verb" },
    { jp: "教える", ro: "oshieru", en: "to teach", tag: "verb" },
    { jp: "習う", ro: "narau", en: "to learn (from someone)", tag: "verb" },
    { jp: "思う", ro: "omou", en: "to think", tag: "verb" },
    { jp: "言う", ro: "iu", en: "to say", tag: "verb" },
    { jp: "知る", ro: "shiru", en: "to know", tag: "verb" },
    { jp: "切る", ro: "kiru", en: "to cut", tag: "verb" },
    { jp: "開ける", ro: "akeru", en: "to open", tag: "verb" },
    { jp: "閉める", ro: "shimeru", en: "to close", tag: "verb" },
    { jp: "始まる", ro: "hajimaru", en: "to begin (something starts)", tag: "verb" },
    { jp: "わかる", ro: "wakaru", en: "to understand", tag: "verb" },
    { jp: "できる", ro: "dekiru", en: "to be able to do", tag: "verb" },
    { jp: "もらう", ro: "morau", en: "to receive", tag: "verb" },
    { jp: "あげる", ro: "ageru", en: "to give (to others)", tag: "verb" },
    { jp: "くれる", ro: "kureru", en: "to give (to me / in-group)", tag: "verb" },
    { jp: "鼻", ro: "hana", en: "nose", tag: "body" },
    { jp: "髪", ro: "kami", en: "hair", tag: "body" },
    { jp: "顔", ro: "kao", en: "face", tag: "body" },
    { jp: "切符", ro: "kippu", en: "ticket", tag: "daily" },
    { jp: "ホテル", ro: "hoteru", en: "hotel", tag: "daily" },
    { jp: "病院", ro: "byōin", en: "hospital", tag: "daily" },
    { jp: "薬", ro: "kusuri", en: "medicine", tag: "daily" },
    { jp: "新幹線", ro: "shinkansen", en: "bullet train", tag: "daily" },
    { jp: "空港", ro: "kūkō", en: "airport", tag: "daily" }
    ],
